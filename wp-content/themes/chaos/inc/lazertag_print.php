		...
		<div class="print_content_in">
			...
			<div class = "print_header">
				<div style="width: 320px; margin: 0 auto; padding: 5px 0px; height: 75px;">
					<div class=header_inside><h2>Lazer Tag Billing</h2></div>
					<br/><br/>
				</div>
			</div>
			...
			<div class=info_bar>
				<div class=customer_info_bar>
					...
					<ul>
						<li><div class="content">Invoice No  </div> <div>: <?php echo $mylink->lazertag_bill_no;?></div></li>
					...
					<table class=display>
						...
						<tbody>
							...
							<?php 
	                            ...
	                            echo "<td class='div-table-col'>".$mylink->lazertag_players."</td>";
	                            echo "<td class='div-table-col'>".$mylink->lazertag_hours."</td>";
	                            echo "<td class='div-table-col'>".$mylink->lazertag_amount."</td>";
							...
							<tr>
								...
								<td><?php  echo $mylink->lazertag_bill;?></td>
							</tr>

...
<div class="search_bar employee_filter">
    ...
    <input type="text" name="gaming_member_name" id="gaming_member_name" autocomplete="off" placeholder="Member Name" size="40" value="<?php echo $gaming_member_name; ?>">
    <input type="text" name="gaming_member_number" id="gaming_member_number" autocomplete="off" placeholder="Member Number" size="40" value="<?php echo $gaming_member_number; ?>">
    <input type="text" name="gaming_bill_date" id="gaming_bill_date"  class="gaming_bill_date" autocomplete="off" placeholder="Bill Paid Date" size="40" value="<?php echo $gaming_bill_date; ?>">
    <input type="text" name="gaming_bill_no" id="gaming_bill_no" autocomplete="off" placeholder="Bill Number" size="40" value="<?php echo $gaming_bill_no; ?>">
    <input type="text" name="gaming_bill_amt" id="gaming_bill_amt" autocomplete="off" placeholder="Bill Amount" size="40" value="<?php echo $gaming_bill_amt; ?>">

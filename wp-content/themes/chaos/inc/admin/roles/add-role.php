									...
									foreach ($src_capabilities as $r_key => $r_value) {
										...
										if(is_array($r_value)) {
											...
											echo '<li class="main_menu" style="border-bottom: 1px solid #ddd;">';
												...
												echo '		<input type="checkbox" name="main_menu[]" value="'.$r_key.'"  class="main_role">';
												echo '	</span>';
												echo '</div>';
											...
											foreach ($r_value['data'] as $d_key => $d_value) {
												...
												echo '				<input type="checkbox" name="main_menu[]" value="'.$d_key.'"  class="sub_role" '.$checked.'>';
												echo '			</span>';
												echo '		</div>';
												echo 		$d_value;
												echo '	</li>';
											...
											echo '	<div class="checker">';
											echo '		<span class="'.$checked.'">';
											echo '			<input type="checkbox" name="main_menu[]" value="'.$r_key.'"  class="main_role" '.$checked.'>';
											echo '		</span>';
											echo '	</div>';

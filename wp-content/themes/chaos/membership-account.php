...
$redeem_remain = 1000-$member_details->balance_points; 
?>
    <section class="ps-bg">
        <div id="home">
            <header>
                            ...
                            <div class="memb-text">
                            	...
                            	<div class="row">
                                    ...
                                    <div class="col-lg-6  col-lg-12">
                                        ...
                                        <?php  var_dump($member_redeem_details); ?>

                                        <?php echo  ($member_details->balance_points >= 1000)?'<p>congrats . .  .!  </p>  <p>You have reached '.$member_details->earned_points.' Points</p> <button><a href="">Redeem NOW</a></button>':'<p>You Need </p><span class="remain_points">'.$redeem_remain.'</span><p> Points to Redeem  </p>'; ?>
                                        </div>                                        
                                    </div>                            		
                        		</div>                        		
                        	</div>
